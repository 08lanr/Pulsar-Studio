  ...
  return (
    <form className="promo-brief" onSubmit={submit}>
      <section className="promo-brief-main card">
        ...
        <div className="field"><label className="label" htmlFor="np-name">{tt("promote.new.campaignName")}</label><input id="np-name" className="input" value={name} onChange={(e) => setName(e.target.value)} required /></div>
        ...
        <div className="field-row"><div className="field"><label className="label">{tt("ws.exp.budget")}</label><input className="input" type="number" min={1} max={100000} value={budget} onChange={(e) => setBudget(e.target.value)} required /><p className="hint">{tt("ws.exp.budgetNote")}</p></div><div className="field"><label className="label" htmlFor="np-audience">{tt("ws.exp.audience")}</label><input id="np-audience" className="input" maxLength={200} value={audience} onChange={(e) => setAudience(e.target.value)} required /></div></div>
        <div className="field"><label className="label" htmlFor="np-hypothesis">{tt("ws.exp.hypothesis")}</label><textarea id="np-hypothesis" className="textarea" rows={3} maxLength={400} value={hypothesis} onChange={(e) => setHypothesis(e.target.value)} required /></div>

...
export const DEFINITIONS: Definition[] = [
  ...
  D({ key: "hook_hold_rate", name_en: "Hook hold rate (2 s)", name_zh: "前 2 秒留存率", unit: "rate", scope: "campaign", window: "campaign result window", denominator: "video views", formula: "Share of video plays still watching at 2 s: TikTok video_watched_2s / video_play_actions per row, view-weighted over result rows (the same field lib/research/assessment.ts benchmarks). TikTok reports 2 s and 6 s watch, never 3 s.", provenance: "calculated", evidence: "observed" }),

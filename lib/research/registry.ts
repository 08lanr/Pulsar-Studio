...
export const METRICS: MetricEntry[] = [
  ...
  },
  {
    ...
    limitations_zh: ["仅在同一平台内比较。", "今天首次发现的作品没有基线，不显示增长。", "需要两个已发布的日期，之前不显示。"],
    status_rule: "history",
  },
  {
    ...
    question_zh: "自上次采集以来，这类题材的作品观看量增加了多少？",
    grain: "trope",
    source_key: "engine",
    ...
    limitations_zh: ["按平台分别计算；不跨平台合计（计数口径与受众不同）。", "今天首次发现或计数字段变化的作品不计入，作为“有基线的作品数”与“作品数”之差呈现。", "统计的是平台公开页面显示的计数；不是收入、不是独立观众、也不代表美国受众。"],
    status_rule: "history",
  },
  {

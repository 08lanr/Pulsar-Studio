...
export default async function SourcesPage(){
 ...
 const used=SOURCES.filter(s=>['catalog','producer','publication'].includes(s.status_rule)||s.key==='engine'||s.key==='producer_reports');
